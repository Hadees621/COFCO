...
<div class="breadcrumb-position">
    <ol class="d-flex text-bold main-container-details">
        ...
        <li class="cursor-pointer underline breadcrumb-item bread  border-none">Points & Shopping Cart Overview</li>
    </ol>
</div>

<!-- Middle -->
<div class="main-container-details tabs-padding mt-4">
    <h1 class="text-bold text-center w-100 pointsAndShoppingTitle">
        Your Scheduled Future Shopping Cart
    </h1>

    <div class="py-2 mt-5">
        <div
            class="d-flex justify-content-between align-content-center grid-on-small-flex-on-large gap-4 center-on-small">
            <div class="d-flex justify-content-start gap-3 align-items-center">
                <img src="/assets/images/order-details/Asset 5.png" alt="asset" />
        ...
        <div class="points-container border-bottom pb-5 center-on-small mt-3 grid-on-small-flex-on-large">
            <div class="d-flex justify-content-between">
                <table class="points-info-table">
                    <tr>
                        <td class="product-nested-description">Your Shopping Cart For This Week</td>
                        <td><span class="points-value">From DD/MM/YYYY To DD/MM/YYYY</span></td>
                    </tr>
                </table>
            </div>
            <button class="manage-account-button flex-middle gap-2 mt-3">
                <img src="/assets/images/order-details/Asset 6.png" class="small-icons" alt="asset" />
                ...
                <div class="w-full d-flex py-3 grid-on-small-flex-on-large center-on-small gap-3">
                    ...
                    <div class="">
                        ...
                        <div class="d-flex m-2 gap-2">
                            <div class="">
                                <img src="/assets/images/order-details/Asset 9.png" class="small-icons" alt="assets"
                                    style="color: #808080;">
                            </div>
                    ...
                    <div class="order-details-left-side d-grid">
                        <div class="d-flex gap-3 align-items-center my-2">
                            <img src="/assets/images/order-details/Asset 6.png" style="height: 14px;" alt="assets" />
                            <p class="product-nested-description text-bold each-product-row ">Date Of
                                Delivery
                            </p>
                        </div>
                        <p class="product-nested-description my-2 text-bold each-product-row " style="color:#C51633;">
                            Monday
                ...
                <div class="d-flex gap-2">
                    <div>
                        ...
                        <div class="d-flex gap-3 mt-3">
                            <img src="/assets/images/order-details/Asset 2.png" style="height: 19px;" alt="assets" />
    ...
    <div
        class="d-flex justify-content-between mt-5 grid-on-small-flex-on-large center-on-small gap-3 main-container-details">
        <div>
            <button class="point-button text-bold"
                style="background-color: white; border: 1px solid #C92540; color: #C92540;">
                <p>Return To The Current Week</p>
            </button>
        </div>

        <div class="d-flex gap-3 grid-on-small-flex-on-large center-on-small">
            <div>
                <button class="manage-account-button disabled"
                    style="background-color: white; border: 1px solid #C92540; color: #C92540;">
                    <p class="text-bold" style="padding: 6px 0px;">View Previous Week</p>
                </button>
            </div>
